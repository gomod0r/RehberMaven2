...
public class Kisi implements Serializable {
    ...
    @NotNull
    @Column(name = "NO")
    @SequenceGenerator(name = "seqkisi", sequenceName = "SEQ_KISI", initialValue = 1, allocationSize = 1)
    @GeneratedValue(generator = "seqkisi", strategy = GenerationType.SEQUENCE)
    private Integer no;
    @Size(max = 255)
    @Column(name = "AD")
    private String ad;
    ...
    public String toString() {
        return "tr.gov.gomodor.rehbermaven.entity.Kisi[ no=" + no + " ]";
    }
